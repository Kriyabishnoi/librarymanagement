...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT ROLL_NO FROM tblstudents WHERE ROLL_NO=:email and STUDENT_MOBILE=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblstudents set Password=:newpassword where ROLL_NO=:email and STUDENT_MOBILE=:mobile";
